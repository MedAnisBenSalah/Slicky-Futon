...
public class UITabView extends UIWidget
{
    ...
    private void initialize()
    {
        ...
        backgroundTexture = Core.getInstance().getResourcesManager().getResource("UI/Empty", ResourceType.RESOURCE_TYPE_TEXTURE_REGION);
    ...
    public void process()
    {
        ...
        for(String tabText : tabs)
        {
            ...
            if(!UIMain.getInstance().isSkipInput() && !selectChanged && Core.getInstance().getInputHandler().isScreenTouched() &&
    ...
    public void render()
    {
        ...
        Core.getInstance().getGraphicsManager().setColor(0f, 0f, 0f, 0.8f);
        // Draw the background
        ...
        for(String tabText : tabs)
        {
            ...
            if(tabText.equals(selectedTab))
                ...
                Core.getInstance().getGraphicsManager().setColor(0.2f, 0.2f, 0.2f, 0.8f);
    ...
    public void addElement(String tab, UIWidget widget)
    {
        ...
        if(!tabContent.containsKey(tab))
            tabContent.put(tab, new Array<UIWidget>());
